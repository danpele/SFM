...
\begin{block}{Rezolvare}
\textbf{1.} Sharpe Ratio: $SR = \frac{\bar{R} - R_f}{\sigma}$.
\begin{itemize}
\item Fond A: $SR_A = \frac{12\% - 4\%}{12\%} = \frac{8\%}{12\%} = 0{,}667$
\item Fond B: $SR_B = \frac{10\% - 4\%}{6{,}75\%} = \frac{6\%}{6{,}75\%} = 0{,}889$
\end{itemize}
...
\textbf{4.} Pentru $SR_A = SR_B$: $\frac{\bar{R}_A - 4\%}{12\%} = 0{,}889$ $\Rightarrow$ $\bar{R}_A = 4\% + 0{,}889 \times 12\% = 14{,}67\%$.
\end{block}
\end{frame}
...
\item $DD_3 = 0\%$, $DD_4 = (90-130)/130 = -30{,}77\%$, $DD_5 = (125-130)/130 = -3{,}85\%$
\end{itemize}
