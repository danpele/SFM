...
\begin{cminipage}{0.95\textwidth}
\begin{center}
    \includegraphics[width=0.50\textwidth]{ch3_emh_tests.pdf}
\end{center}
\vspace{-0.1cm}
\begin{itemize}\setlength{\itemsep}{0pt}
...
\small
\begin{center}
    \includegraphics[width=0.50\textwidth]{ch3_efficiency_comparison.pdf}
\end{center}
...
\small
\begin{center}
    \includegraphics[width=0.80\textwidth]{ch3_variance_ratio.pdf}
\end{center}

\vspace{-0.1cm}
\begin{itemize}\setlength{\itemsep}{0pt}
    \item \textbf{VR mobil} (500 zile, $q = 5$): $|VR - 1|$ crește abrupt în crize (2008, 2020) și scade în perioade calme
    \item \textbf{Hurst mobil} (500 zile): $H$ crește de la $\sim$0{,}50 la $\sim$0{,}60 în perioade de stres
    \item \textbf{Implicație:} eficiența nu este constantă --- piața oscilează între eficiență și ineficiență, confirmând AMH
\end{itemize}
\end{cminipage}
\quantlet{SFM\_ch3\_variance\_ratio}{https://github.com/QuantLet/Stat_fin_markets/tree/master/Ch_03/SFM_ch3_variance_ratio}
\end{frame}
