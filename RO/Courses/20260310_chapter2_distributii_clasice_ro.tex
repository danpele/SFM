...
%--- PhD Slide 5c: Wasserstein în stress-testing ---
\slidelevel{PhD}
...
\begin{itemize}\setlength{\itemsep}{0pt}
\item {\small $T = \tfrac{1}{252 \times 10^{-89}} \approx 4 \times 10^{86}$ ani; vârsta universului: $\approx 1{,}4 \times 10^{10}$ ani}
\item {\small \textbf{$\Rightarrow$ $\boldsymbol{\sim 10^{76}}$ vârste ale universului!}}
\end{itemize}
\end{alertblock}
\end{column}
\end{columns}
...
\item Distribuția normală subestimează sistematic riscul de coadă
\end{itemize}
\end{alertblock}
\end{frame}
...
\vspace{0.1cm}
\begin{itemize}
\item {\small $\kappa_e = 7$ pentru S\&P~500 $\Rightarrow$ cozi \textbf{substanțial mai groase} decât distribuția normală}
\end{itemize}
\end{column}
\end{columns}
\end{frame}
...
\end{column}
\begin{column}{0.48\textwidth}
\begin{block}{Pareto: \textbf{lupa pe coadă}}
\begin{itemize}\setlength\itemsep{2pt}
...
\item Indicele de coadă Pareto $\alpha$ = gradele de libertate $\nu$ ale Student-$t$
...
\item Aliniere pe dreaptă $\Rightarrow$ comportament Pareto
\item Abaterea pentru $x$ mici: \textit{trunchiere}
\end{itemize}
\end{block}
\end{column}
\end{columns}
...
\vspace{-0.2cm}
\begin{center}
\includegraphics[width=0.85\textwidth]{ch2_pareto_mle_demo.pdf}
\end{center}
\vspace{-0.4cm}
\quantlet{SFM\_ch2\_pareto\_analysis}{https://github.com/QuantLet/Stat_fin_markets/tree/master/SFM_ch2/SFM_ch2_pareto_analysis}
\vspace{-0.1cm}
\begin{itemize}\setlength\itemsep{1pt}
\item \textbf{Stânga}: histogram + fit MLE vs.\ valoarea adevărată ($\alpha = 3$, $n = 1000$)
\item \textbf{Dreapta}: convergența MLE pe măsură ce $n$ crește ($n = 50 \to 5000$)
\end{itemize}
\end{frame}
...
\vspace{-0.2cm}
\begin{center}
\includegraphics[width=0.88\textwidth]{ch2_pareto_hill_sp500.pdf}
\end{center}
\vspace{-0.4cm}
\quantlet{SFM\_ch2\_pareto\_analysis}{https://github.com/QuantLet/Stat_fin_markets/tree/master/SFM_ch2/SFM_ch2_pareto_analysis}
\vspace{-0.1cm}
...
\begin{center}
\includegraphics[width=0.95\textwidth]{ch2_pareto_tail_fitting.pdf}
\end{center}
\vspace{-0.3cm}
\quantlet{SFM\_ch2\_pareto\_analysis}{https://github.com/QuantLet/Stat_fin_markets/tree/master/SFM_ch2/SFM_ch2_pareto_analysis}
\begin{itemize}\setlength\itemsep{2pt}
\item \textbf{QQ-plot}: aliniere pe diagonală $\Rightarrow$ coada este Pareto
...
\begin{itemize}\setlength\itemsep{2pt}
\item \textbf{Pasul 1}: Selectăm pragul $u$ (sau fracția de coadă, e.g.\ top 5\%)
...
\begin{frame}{Studiu de caz: Concluzii}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item ES Normal la 1\% subestimează pierderea medie din coadă cu \textbf{30--50\%} față de Student-$t$
...
\slidelevel{Y3}
\begin{frame}[shrink=3]{Exercițiu AI: Distribuții și risc de coadă}
    \begin{cminipage}{0.95\textwidth}
    \begin{block}{\footnotesize Prompt de testat în ChatGPT / Claude / Copilot}
        ...
        Estimează indicele de coadă Pareto cu estimatorul Hill.''}
    \end{block}
    \vspace{-1mm}
    {\small
    \textbf{Exercițiu}:
...
\end{itemize}
\item Student-$t$ câștigă pe ambele criterii (AIC: $-23{,}6 < -21{,}0$; BIC: $-25{,}44 < -22{,}23$)
