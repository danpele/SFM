...
\input{preamble}
\subtitle{Seminar 4: Estimatori de Volatilitate}
...
\begin{frame}[shrink=35]{Exercițiul 2: Estimatorul Parkinson}
    \begin{cminipage}{0.95\textwidth}
    \begin{block}{Enunț}
    \begin{center}
    {\small\renewcommand{\arraystretch}{1.3}
...
\begin{frame}[shrink=40]{Vizualizare: Frontiera Eficientă (10\,000 Portofolii)}
\begin{cminipage}{0.95\textwidth}
    \begin{center}
    \includegraphics[width=0.60\linewidth]{sfm_sem5_efficient_frontier.png}
    \end{center}
    \vspace{-0.4cm}
    {\small
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item Fiecare punct = un portofoliu aleatoriu; culoarea = Sharpe ratio
        \item \textbf{Steaua roșie}: portofoliul optim (Sharpe maxim $\approx 0{,}79$)
        \item Romburile: activele individuale --- toate sunt \textbf{sub} frontieră
        \item Zona verde (Sharpe $> 0{,}7$): concentrate în colțul stânga-sus
    \end{itemize}
    }
    \quantlet{SFM\_ch1\_volatility\_estimators}{https://github.com/QuantLet/Stat_fin_markets/tree/master/Ch_01/SFM_ch1_volatility_estimators}
\end{cminipage}
...
\begin{frame}[shrink=10]{Vizualizare: Alocarea Portofoliului Optim}
\begin{cminipage}{0.95\textwidth}
    \begin{center}
    \includegraphics[width=0.65\linewidth]{sfm_sem5_optimal_portfolio.png}
    \end{center}
    \vspace{-0.3cm}
    \begin{exampleblock}{Lecții cheie}
    \begin{itemize}\setlength{\itemsep}{0pt}
        \item \textbf{SPY} domină ($\sim$64\%) --- randament+risc echilibrat
        \item \textbf{GLD} intră $\sim$19\% deși are cel mai mic randament --- \textbf{corelație scăzută} cu acțiunile
        \item \textbf{TLT, VNQ} aproape zero --- $SR < 0$ sau risc prea mare
        \item Diversificarea reduce $\sigma_p$ sub orice activ individual
    \end{itemize}
    \end{exampleblock}
    \quantlet{SFM\_ch1\_volatility\_estimators}{https://github.com/QuantLet/Stat_fin_markets/tree/master/Ch_01/SFM_ch1_volatility_estimators}
\end{cminipage}
...
\begin{frame}{}
    ...
    \href{https://quantlet.com}{\raisebox{-0.15em}{\includegraphics[height=0.8em]{ql_logo.png}} Quantlet} \quad
