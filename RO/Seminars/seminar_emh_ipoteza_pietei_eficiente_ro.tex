...
\begin{frame}{Cuprins Seminar}
    ...
    \begin{itemize}\setlength{\itemsep}{0pt}
        ...
        \vspace{0.1cm}
        \item \textbf{Partea III: Anomalii și Adaptive Market Hypothesis (AMH)} -- Heavy tails, anomalii calendaristice, Hurst, adevărat/fals
        \vspace{0.1cm}
        ...
        \vspace{0.1cm}
        \item \textbf{Temă} -- Eficiența pe Bursa de Valori București (BVB)
        \vspace{0.1cm}
...
\begin{itemize}\setlength{\itemsep}{0pt}
    ...
    \item Realiza un event study complet (Abnormal Return, AR; Cumulative Abnormal Return, CAR)
...
\begin{cminipage}{0.95\textwidth}
    ...
    \begin{enumerate}\setlength{\itemsep}{0pt}
        ...
        \item Hurst: metoda R/S sau Detrended Fluctuation Analysis (DFA)? Rezultatele sunt în $[0.4, 0.7]$?
...
\begin{cminipage}{0.95\textwidth}
    ...
    \begin{enumerate}\setlength{\itemsep}{0pt}
        ...
        \item Modelul normal folosește regresie Ordinary Least Squares, OLS ($R_i = \alpha + \beta R_m + \varepsilon$)?
