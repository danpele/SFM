...
\begin{itemize}\setlength{\itemsep}{0pt}
    ...
    \item High Minus Low (HML) factor: $\sim$4\% per year historically
...
\begin{itemize}\setlength{\itemsep}{0pt}
    ...
    \item Small Minus Big (SMB) factor: $\sim$2\% per year
...
\begin{itemize}\setlength{\itemsep}{0pt}
    ...
    \item Winners Minus Losers (WML) factor: $\sim$8\% per year
